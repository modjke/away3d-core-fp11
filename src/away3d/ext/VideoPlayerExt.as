...
public class VideoPlayerExt extends EventDispatcher implements IVideoPlayer
{

	public static const STARTED:String = "videoStarted";
	public static const ENDED:String = "videoEnded";
	...
	public function VideoPlayerExt()
	{
	...
	private function netStatusHandler(e:NetStatusEvent):void
	{
		switch (e.info["code"]) {
			case "NetStream.Play.Stop":
				this.dispatchEvent( new Event(VideoPlayerExt.ENDED) );
				if (loop)
					_ns.play(_src);

				break;
			case "NetStream.Play.Start":
				this.dispatchEvent( new Event(VideoPlayerExt.STARTED) );
				break;
